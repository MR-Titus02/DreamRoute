...
function Login() {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-[#222831] via-[#393E46] to-[#222831] relative overflow-hidden flex flex-col justify-between">
      ...
      {/* Header */}
      <header className="relative z-10 flex items-center justify-between px-4 lg:px-8 py-2 bg-black/10 backdrop-blur-sm border-b border-white/10">
  ...
  <p className="text-red-400 bg-white/10 p-2 rounded text-sm text-center font-inter">
    {error}
              ...
              {/* Sign up link */}
              <p className="text-center text-white/70 font-inter mt-2">
