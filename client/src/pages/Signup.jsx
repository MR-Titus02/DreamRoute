...
function SignUp() {
  ...
  className="flex items-center justify-center gap-2 py-2 border border-white/20 rounded-lg bg-white/5 hover:bg-white/10 transition-all text-white text-sm"
>
